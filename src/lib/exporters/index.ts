 ...
 *
 * Order in this array drives the order in the File → Export submenu.
 * To add a new format: create a module exporting an `Exporter`, then add it
 * to the array below. No menu code changes needed.
 */
